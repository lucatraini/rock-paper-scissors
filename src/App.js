  ...
  return (
    <>
      <div className="container">
        <Header score={score} houseScore={houseScore} />
        <Routes>
          ...
          <Route
            path="/game"
            element={
              <Game myChoice={myChoice} score={score} setScore={setScore} user={user} setHouseScore={setHouseScore} houseScore={houseScore}
